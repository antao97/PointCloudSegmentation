...
class Dataset(data.Dataset):
    def __init__(self, root, dataset_name='modelnet40', class_choice=None,
        ...
        if dataset_name not in ['shapenetcorev2', 'shapenetpart', 'shapenetpartpart'] and segmentation == True:
        ...
        if self.dataset_name == 'shapenetpartpart':
    ...
    def __getitem__(self, item):
        ...
        if self.segmentation:
            ...
            if self.dataset_name == 'shapenetpartpart':
                return point_set, seg.unsqueeze(1)[0]
            else:
